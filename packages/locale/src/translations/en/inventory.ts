export const inventory = {
  ...
  kanbanEditDescription: "Update the kanban information for scan-based replenishment.",
  kanbanNewDescription: "Create a new kanban card for scan-based replenishment.",
  quantityHelper: "The quantity of the item to be reordered on scan-based replenishment.",
  replenishmentSystem: "Replenishment System",
  purchaseUnitOfMeasure: "Purchase Unit of Measure",
  conversionFactor: "Conversion Factor",
  conversionFactorHelper: "Number of inventory units per purchase unit",
  autoRelease: "Auto Release",
  autoReleaseDescription: "Automatically release the job when the kanban is scanned",
  autoStartJob: "Auto Start Job",
  autoStartJobEnabled: "Automatically start the job when the kanban is scanned",
  autoStartJobDisabled: "Auto release must be enabled to start a job automatically",
  completionBarcode: "Completion Barcode",
  autoGeneratedQrCode: "Auto-generated QR Code",
  updateKanban: "Update Kanban",
