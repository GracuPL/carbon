    ...
    <>
      <Table<SalesInvoice>
        ...
        primaryAction={
          permissions.can("create", "invoicing") && (
            <New label={t("salesInvoice")} to={path.to.newSalesInvoice} />
          )
        }
      ...
      {selectedSalesInvoice && selectedSalesInvoice.id && (
        <ConfirmDelete
          ...
          text={t("confirmDeleteSalesInvoice", { name: selectedSalesInvoice.invoiceId! })}
          onCancel={() => {
