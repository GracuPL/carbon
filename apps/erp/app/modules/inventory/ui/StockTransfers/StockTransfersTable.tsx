        ...
        return (
          <>
            ...
            >
              ...
              {row.completedAt ? t("viewStockTransfer") : t("editStockTransfer")}
            </MenuItem>
            <MenuItem
              disabled={
      ...
      <>
        ...
        {selectedStockTransfer && selectedStockTransfer.id && (
          <ConfirmDelete
            ...
            text={t("confirmDeleteStockTransfer", { name: selectedStockTransfer.stockTransferId! })}
            onCancel={() => {
